...
if (isset($_GET["modalidadeId"])) {
    ...
    $processedDoctors = array(); 

    while ($row = $result->fetch_assoc()) {
        $id_medico = $row['id_medico'];

        if (!in_array($id_medico, $processedDoctors)) { //Verificar esse array, pois ele é importante para não duplicar o mesmo medico, mas ele está fazendo os medicos sumirem ao ir para outro calendario.
